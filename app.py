...
filtered_data = raw[(raw['Age_bins'].isin(age_filter)) & (raw['Year'].isin(year_filter))]
...
fig_beh = px.bar(result_melted, x='Quarter', y='Sum', color='Behaviour', barmode = "stack",
